...
function gameTick() {
	...
	if (tab=='gen') {
		...
		if (genTab=='neutronTiers') {
			updateElement('neutrons','You have <b>'+format(player.neutrons)+'</b> neutrons,  reducing generator costs by <b>'+format(neutronPower)+'x</b>.')
